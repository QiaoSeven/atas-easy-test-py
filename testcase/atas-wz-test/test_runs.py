...
class TestRuns:
    ...
    def test_create_run(driver, data, capture, logger, atas_api):
    ...
    @pytest.mark.parametrize("driver", browser_data, indirect=True)
    def test_edit_run(driver, data, capture, logger, atas_api):
        def_name = sys._getframe().f_code.co_name
        # 数据
        data = get_data[def_name]
        nv = NavigateTask(driver, data)
        ...
        # if_project可选择True/False。表示是否需要从project菜单进入子层级
        # if_verify可选择True/False。表示是否需要校验操作结果
        run.edit_run(True, "Run List Page", True)
        # if_project可选择True/False。表示是否需要从project菜单进入子层级
    ...
    @pytest.mark.parametrize("driver", browser_data, indirect=True)
    def test_duplicate_run(driver, data, capture, logger, atas_api):
        def_name = sys._getframe().f_code.co_name
        # 数据
        data = get_data[def_name]
        nv = NavigateTask(driver, data)
    ...
    @pytest.mark.parametrize("driver", browser_data, indirect=True)
    def test_delete_run(driver, data, capture, logger, atas_api):
        def_name = sys._getframe().f_code.co_name
        # 数据
        data = get_data[def_name]
        nv = NavigateTask(driver, data)
    ...
    @pytest.mark.parametrize("driver", browser_data, indirect=True)
    def test_edit_run_scope(driver, data, capture, logger, atas_api):
        def_name = sys._getframe().f_code.co_name
        # 数据
        data = get_data[def_name]
        nv = NavigateTask(driver, data)
    ...
    @pytest.mark.parametrize("driver", browser_data, indirect=True)
    def test_assign_cases(driver, data, capture, logger, atas_api):
        def_name = sys._getframe().f_code.co_name
        # 数据
        data = get_data[def_name]
        nv = NavigateTask(driver, data)
    ...
    @pytest.mark.parametrize("driver", browser_data, indirect=True)
    def test_filter_cases(driver, data, capture, logger, atas_api):
        def_name = sys._getframe().f_code.co_name
        # 数据
        data = get_data[def_name]
        nv = NavigateTask(driver, data)
    ...
    @pytest.mark.parametrize("driver", browser_data, indirect=True)
    def test_search_cases(driver, data, capture, logger, atas_api):
        def_name = sys._getframe().f_code.co_name
        # 数据
        data = get_data[def_name]
        nv = NavigateTask(driver, data)
    ...
    @pytest.mark.parametrize("driver", browser_data, indirect=True)
    def test_execute_case(driver, data, capture, logger, atas_api):
        def_name = sys._getframe().f_code.co_name
        # 数据
        data = get_data[def_name]
        nv = NavigateTask(driver, data)
    ...
    @pytest.mark.parametrize("driver", browser_data, indirect=True)
    def test_check_case_history(driver, data, capture, logger, atas_api):
        def_name = sys._getframe().f_code.co_name
        # 数据
        data = get_data[def_name]
        nv = NavigateTask(driver, data)
        ...
        run = RunTask(driver, data, capture, logger, atas_api)
        run.run_history(True, True, True, "Untest", "before", "All", True)
        # if_project可选择True/False。表示是否需要从project菜单进入子层级
        # if_list_page可选择True/False。表示是否需要从run list page进入自从子层级
        # if_detail_page可选择True/False。表示是否需要从run detail page进入自从子层级
        ...
        # if_attach可选择True/False。表示是否上传attachment
        # if_verify可选择True/False。表示是否需要校验操作结果
        run.run_history(False, False, False, "Untest", "after", "All", True)
        driver.get_driver().quit()

    @pytest.mark.parametrize("driver", browser_data, indirect=True)
    def test_unlink_issue(driver, data, capture, logger, atas_api):
        def_name = sys._getframe().f_code.co_name
        # 数据
        data = get_data[def_name]
        nv = NavigateTask(driver, data)
